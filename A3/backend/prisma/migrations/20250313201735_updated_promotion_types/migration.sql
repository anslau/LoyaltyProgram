...
INSERT INTO "new_Promotion" ("description", "endTime", "id", "minSpending", "name", "points", "rate", "startTime", "type") SELECT "description", "endTime", "id", coalesce("minSpending", 0) AS "minSpending", "name", coalesce("points", 0) AS "points", coalesce("rate", 0) AS "rate", "startTime", "type" FROM "Promotion";
